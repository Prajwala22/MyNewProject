...
//                                                             <CKEditor5
//                                                                 initialData={headerval}
//                                                                 onChange={value => { onHeaderTextChange(value), setHeaderValError(false) }}
...
//                                                             <CKEditor5
//                                                                 initialData={headerval}
//                                                                 data={editPrintDesignData.printHeaderSettings.headerDetails}
//                                                                 onChange={value => { onHeaderTextChange(value), setHeaderValError(false) }}
//                                                                 editorConfig={{ toolbar: ['FontFamily', 'heading', 'bold', 'italic', 'underline', 'bulletedList', 'numberedList', 'fontSize', '|', 'undo', 'redo',] }}
//                                                                 onFocus={() => { }}
//                                                                 onBlur={() => { }}
...
//                                                             <CKEditor5
//                                                                 initialData={footerval}
//                                                                 data={editPrintDesignData.printFooderSettings.fooderDetails}
//                                                                 onChange={value => { onFooterTextChange(value), setFootervalError(false) }}
//                                                                 editorConfig={{ toolbar: ['FontFamily', 'heading', 'bold', 'italic', 'underline', 'bulletedList', 'numberedList', 'fontSize', '|', 'undo', 'redo',] }}
//                                                                 onFocus={() => { }}
//                                                                 onBlur={() => { }}
