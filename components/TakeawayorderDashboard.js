...
export default function TableViewTakeawayorderDashboard({ data, sendEditData, ...props }) {
    ...
    const tableRow = (taxData) => (
        <View style={[styles.tableRow, { borderColor: showView && showViewId == taxData.orderId ? '#407C6A' : '#F5F3F6' }]} >
            <DataTable.Row style={styles.datatableextraline} key={taxData.orderItemsStatus}>
                ...
                <DataTable.Cell><Text style={styles.tableCell}>{taxData.customerName}</Text></DataTable.Cell>
    ...
    :
        <DataTable {...props}>
            <DataTable.Header>
                ...
                <DataTable.Title><Text style={styles.tableHeader}>Items</Text></DataTable.Title>
                ...
                <DataTable.Title style={[styles.flexSl]}><Text style={styles.tableHeader}>Action</Text>
                </DataTable.Title>
            </DataTable.Header>
            <ScrollView >
